...
export type PipelineStageConfig<Input = any, Output = any> = {
     ...
     */
    validateOutput?: (data: Output, ctx: {
        allResults: Record<string, PipelineStepResult>;
        sharedData: Record<string, any>;
        signal: AbortSignal;
...
export type PipelineItem = PipelineStageConfig | ParallelStageGroup | SubPipelineStage | StreamStageConfig | WebSocketStageConfig;
/**
...
export type WebSocketStageConfig<T = unknown> = {
    ...
    onOpen?: (params: WebSocketStageHookParams & {
        event: unknown;
    }) => void | Promise<void>;
    /**
     ...
     */
    onMessage: (data: unknown, params: WebSocketStageHookParams & {
        event: unknown;
    ...
    onClose?: (params: WebSocketStageHookParams & {
        code?: number;
        reason?: string;
        wasClean?: boolean;
    }) => void | Promise<void>;
