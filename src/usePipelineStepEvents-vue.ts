 ...
 */
export function usePipelineStepEventVue(
 ...
 * @returns Ref<log[]>
 */
export function usePipelineLogsVue(orchestrator: PipelineOrchestrator) {
 ...
 */
export function useRerunPipelineStepVue(orchestrator: PipelineOrchestrator) {
